...
#for GCF in linemibig[1363:1436]:
#for GCF in linemibig[1436:]:
#for GCF in linemibig[1639:]:
for GCF in linemibig[1726:1768]:
    GCF=GCF.split('\t')[1]
    #GCF='BGC0001089'
    #if os.path.exists(GCF_fold_root+'/'+GCF) ==True and os.path.exists(GCF_fold_root+'/'+GCF+'/'+GCF+'_BGC_result') == False:
    if os.path.exists(GCF_fold_root+'/'+GCF) ==True:
